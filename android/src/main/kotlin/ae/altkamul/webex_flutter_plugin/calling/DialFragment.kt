...
import ae.altkamul.webex_flutter_plugin.databinding.FragmentCallBinding
import ae.altkamul.webex_flutter_plugin.utils.extensions.hideKeyboard
import ae.altkamul.webex_flutter_plugin.utils.extensions.showKeyboard
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ibStartCall.setOnClickListener {
            ...
            if (isAddingCall) {
                ...
                intent.putExtra(
                    "switchToUcOrWebexCalling",
                    switchToCucmOrWxcCallToggle
                )

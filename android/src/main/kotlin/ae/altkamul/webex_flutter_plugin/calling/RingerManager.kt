...
open class RingerManager(private val androidContext: Context): KoinComponent {
    ...
    private fun handleStartRinger(type: Call.RingerType) {
        ...
        when (type) {
            ...
            Call.RingerType.DTMF_A -> TODO()
            Call.RingerType.DTMF_B -> TODO()
            Call.RingerType.DTMF_C -> TODO()
            Call.RingerType.DTMF_D -> TODO()
            Call.RingerType.DTMF_FLASH -> TODO()
            Call.RingerType.PICKUP_ALERT -> TODO()
            Call.RingerType.PICKUP_BUSY_TONE -> TODO()
            Call.RingerType.CALLPARK_EXPIRE -> TODO()
            Call.RingerType.Undefined -> TODO()
        }
    }
